...
if __name__ == "__main__":
    ...
    logger.info('Text translation test:')
    
    inputText = """
Nowe postępy w wykrywaniu obecności larw Hylotrupes bajulus L. w praktycznych warunkach konstrukcji dachów metodą AE – rejestracja dwukanałowa
    """
